...
<head>
  ...
  <title>Pages / Login - owaiz-architects admin</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="<?php echo base_url();?>" class="logo d-flex align-items-center w-auto">
                  <img  src="<?php echo base_url('assets/asset/images/logoo.png')?>" alt="">
                  <!-- <span class="d-none d-lg-block">owaiz-architects</span> -->
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action="<?php echo base_url('admin/login_process')?>" method="POST" class="row g-3 needs-validation" novalidate>
